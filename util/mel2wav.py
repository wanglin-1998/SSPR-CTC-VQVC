...
if __name__ == "__main__":
    ...
    #wav_dir = sys.argv[2]
    #mel_npy_dir = '/student/home/wl/wl2021/vqvae_vq40_q64_base/mel_vq40_base_zs_wl/clb20.to.bdl100' 
    mel_npy_dir ='/ssdhome/wl/wl2021/vqvae_vq40_q64_base/111'
    wav_dir = '/ssdhome/wl/wl2021/vqvae_vq40_q64_base/0db_wav'
    
    os.makedirs(wav_dir, exist_ok=True)
    mel2wav(mel_npy_dir, wav_dir)
